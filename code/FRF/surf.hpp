...
public:
    ...
    void detectAndCompute(InputArray img, InputArray mask,
                          ...
                          bool useProvidedKeypoints = false, CV_OUT std::vector<DetPoint>& detpoints = std::vector<DetPoint>());//------Add the attribution-------
...
public:
   ...
   // int descriptorSize() const { return params->extended ? 128 : 64; }
    ...
    void downloadKeypoints(const UMat &keypointsGPU, std::vector<KeyPoint> &keypoints, std::vector<DetPoint>& detpoints= std::vector<DetPoint>());//-------------
    ...
    bool detect(InputArray img, InputArray mask, UMat& keypoints, std::vector<DetPoint>& detpoints = std::vector<DetPoint>());
    //! finds the keypoints and computes their descriptors.
    //! Optionally it can compute descriptors for the user-provided keypoints and recompute keypoints direction
    bool detectAndCompute(InputArray img, InputArray mask, UMat& keypoints,
                          OutputArray descriptors, bool useProvidedKeypoints = false, std::vector<DetPoint>& detpoints= std::vector<DetPoint>());
